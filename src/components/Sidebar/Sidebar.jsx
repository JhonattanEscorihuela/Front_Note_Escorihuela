      ...
      <div className='sidebar-content py-3 flex flex-column'>
        ...
        <ul className='links my-4'>
          ...
          <Link to="/add" className={`text-white flex justify-center align-center link-item ${pathname === 'add' ? 'active-link' : ""}`}>
            ...
            <span className='icon-text'>Add a task</span>
          </Link>
          <Link to="/archived" className='text-white flex justify-center align-center link-item'>
            <span className='flex align-center justify-center'>
              <PiArchiveDuotone size={17} />
            </span>
            <span className='icon-text'>Archived</span>
          </Link>
        </ul>
      </div>
    </div>
